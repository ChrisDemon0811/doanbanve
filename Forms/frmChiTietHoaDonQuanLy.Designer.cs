...
{
    partial class frmChiTietHoaDonQuanLy
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlDanhSach.Location = new Point(16, 192);
            pnlDanhSach.Name = "pnlDanhSach";
            pnlDanhSach.Padding = new Padding(12);
            pnlDanhSach.Size = new Size(668, 362);
            ...
            label1.TabIndex = 3;
            label1.Text = "Gồm các vé:";
            label1.Click += label1_Click;
            // 
            // frmChiTietHoaDonQuanLy
            // 
            ...
            MaximizeBox = false;
            Name = "frmChiTietHoaDonQuanLy";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Chi tiết hóa đơn";
            Load += frmChiTietHoaDonQuanLy_Load;
