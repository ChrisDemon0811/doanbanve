    ...
    public partial class frmDashboardQuanLy : Form
    {
        ...
        private async Task TaiDanhSachVe()
        {
            ...
            dgvVe.Columns.AddRange(new DataGridViewColumn[]
            {
                ...
                new DataGridViewTextBoxColumn { Name = "colThongTinVe", HeaderText = "Thông tin vé" }
            });
        ...
        private Ve? LayVeDangChon()
        {
            ...
            if (dgvVe.CurrentRow.Cells.Count < 10)
            {
                return null;
            }
            ...
            return new Ve
            {
                ...
                ThongTinVe = dgvVe.CurrentRow.Cells[9].Value?.ToString(),
                TrangThai = true
            };
        }
