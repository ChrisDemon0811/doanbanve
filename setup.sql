...
(
    ...
    GiaNguoiCaoTuoi DECIMAL(18,2) NOT NULL,
...
(
    ...
    SoLuongNguoiCaoTuoi INT NOT NULL,
    DonGiaNguoiLon DECIMAL(18,2) NULL,
...
(
    ...
    SoLuongTreEm INT NOT NULL,
    SoLuongNguoiCaoTuoi INT NOT NULL,
    DonGiaNguoiLon DECIMAL(18,2) NOT NULL,
    DonGiaTreEm DECIMAL(18,2) NOT NULL,
...
VALUES 
    (N'Vé tham quan', N'Vé vào cổng và tham quan các khu vực chung', 1),
    (N'Vé vui chơi', N'Vé tham gia các trò chơi mạo hiểm và cảm giác mạnh', 1),
    (N'Vé Combo', N'Vé trọn gói bao gồm vào cổng và tất cả trò chơi', 1);
GO

-- 2. Thêm dữ liệu mẫu cho bảng Ve (Chi tiết các vé thuộc Loại vé)
-- Giả sử:
...
VALUES 
    (1, GETDATE(), 500000.00, 1, 50000.00, N'ChuyenKhoan', N'DaThanhToan'),
